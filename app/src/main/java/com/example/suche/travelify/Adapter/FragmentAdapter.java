...
public class FragmentAdapter extends FragmentPagerAdapter{
    ...
    // Count of Tabs.
    final private int PAGE_COUNT[] = {-1,3,5,2,3};
    ...
    public CharSequence getPageTitle(int position) {
        ...
        if(type==2){
            switch (position){
                ...
                case 4:     return mContext.getResources().getString(R.string.category_zoo);
                default:    return null;
            }
        }
        if(type==3){
